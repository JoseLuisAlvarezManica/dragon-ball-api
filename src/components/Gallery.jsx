            ...
            {loading ? (
                ...
                <ul className='grid grid-cols-2 gap-4'>
                    {data.items.map((item, index) => {
                        return (
                            <li key={index} className='bg-gray-100 p-4 rounded-lg flex flex-col justify-center items-center '>
                                <img src={item.image} alt={item.name} className='h-64 text-center' />
